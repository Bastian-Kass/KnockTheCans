...
public class TargetCollisionManager : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if(collision.gameObject.CompareTag("GameBall") && InTargetZone){
            ...
            if(ball.ballState == GameBallManager.GameBallState.Thrown)
                OnTargetHit.Invoke(collision);

        }

        // // Need more sound effects to randomize
        // // TODO: Get the propper value programatically for the audio to trigger, now using 2
        // // TODO: Get more audios randomize and add variety
